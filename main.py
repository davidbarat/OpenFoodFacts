...
list_products_selected = [i[0] for i in list_products_selected]
...
barcode_product_substitute = my_database.select_better('openfoodfacts', 
    answer_category)
...
if answer_research == 'o':
    my_database.select_products_selected('openfoodfacts', 'products_selected')
else:
    print('\n')
